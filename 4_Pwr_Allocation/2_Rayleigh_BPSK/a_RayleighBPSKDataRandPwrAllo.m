...
dataErrPlt = figure(1);
dataErrPlt.Name = 'Transmission Data Error for Rayleigh Fading Channel with BPSK Modulation';
dataErrPlt.WindowState = 'maximized';
% Plot data error distribution (Theoretical)
stem(Xn, Mn, 'LineWidth', 1.5, 'Color', '#0072BD');
title('\bf Theoretical Data Error Distribution (Rayleigh Fading Channel, BPSK)', ...
    textTheoParam, 'Interpreter', 'latex', 'FontName', 'Times New Roman');
...
title('\bf Measured Data Error Distribution (Raylegh Fading Channel, BPSK)', ...
    textMeasParam, 'Interpreter', 'latex', 'FontName', 'Times New Roman');
xlabel('\bf Data Error Value', 'Interpreter', 'latex', 'FontName', ...
    'Times New Roman');
ylabel('\bf PDF', 'Interpreter', 'latex', 'FontName', 'Times New Roman');
text(0.5, 0.5, textJakes, 'HorizontalAlignment', 'left', 'Interpreter', ...
    'latex', 'FontSize', 24, 'FontName', 'Times New Roman');
text(0.5, 0.45, textRayleigh, 'HorizontalAlignment', 'left', 'Interpreter', ...
    'latex', 'FontSize', 24, 'FontName', 'Times New Roman');
set(gca, 'Fontsize', 24);

% Data error distribution figure settings
pwrAlloPlt = figure(3);
pwrAlloPlt.Name = 'Transmission Power Allocation for Rayleigh Fading Channel with BPSK Modulation';
...
title('\bf Transmission Power Variation (Rayleigh Fading Channel, BPSK)', ...
    textMeasParam, 'Interpreter', 'latex', 'FontName', 'Times New Roman');

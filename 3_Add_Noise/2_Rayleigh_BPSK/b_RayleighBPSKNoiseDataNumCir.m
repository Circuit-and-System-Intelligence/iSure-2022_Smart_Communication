...
% Plot received data
recvPlt = figure(1);
recvPlt.Name = 'Received Data of Different Numbers (Rayleigh Channel, BPSK Modulation)';
...
% Plot bit error
errPlt = figure(2);
errPlt.Name = 'Transmission Error of Different Numbers (Rayleigh Channel, BPSK Modulation)';

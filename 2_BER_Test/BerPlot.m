...
semilogy(nEbn0, berTheoAwgnBpsk, "LineWidth", 2, "Color", "#0072BD", "Marker", "square");
hold on
semilogy(nEbn0, berTheoRayBpsk, "LineWidth", 2, "Color", "#D95319", "Marker", "square");
semilogy(nEbn0, berAwgnBpsk, "LineWidth", 2, "Color", "#0072BD", "Marker", "o");
